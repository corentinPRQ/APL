...
public class RectoratHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, pRectorat.Rectorat t)
    {
        a.insert_Streamable(new pRectorat.RectoratHolder(t));
    }
     ...
     */
    public static pRectorat.Rectorat extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof pRectorat.RectoratHolder)
                    return ((pRectorat.RectoratHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            pRectorat.RectoratHolder h = new pRectorat.RectoratHolder(read(a.create_input_stream()));
     ...
     */
    public static pRectorat.Rectorat read(org.omg.CORBA.portable.InputStream istream)
    {
